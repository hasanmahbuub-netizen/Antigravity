            ...
            <div className="relative z-10 px-6 max-w-[600px] flex flex-col items-center">
                ...
                >
                    ...
                    <div className="flex gap-4 w-full justify-center">
                        <button className="px-6 py-3 rounded-full border border-[#D4AF37]/30 text-[#D4AF37] hover:bg-[#D4AF37]/10 transition-colors font-medium">
                            Yes, I can
                        </button>
                        <button className="px-6 py-3 rounded-full bg-[#D4AF37] text-[#0A1628] hover:bg-[#C4A030] transition-colors font-medium shadow-[0_0_20px_rgba(212,175,55,0.2)]">
                            No, teach me
                        </button>
                    </div>
                </motion.div>
                ...
                >
                    <span>Scroll to see what happens next</span>
