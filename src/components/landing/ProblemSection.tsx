        ...
        <section ref={ref} className="min-h-screen flex flex-col items-center justify-center bg-[#1A1A1A] text-white px-6 py-20">
            <div className="max-w-2xl text-center space-y-12">
                ...
                <div className="space-y-6 text-xl md:text-3xl text-gray-400 font-light font-english">
                    ...
                    <RevealText show={isInView} delay={1.5}>
                        Most can't read the Quran fluently
                    </RevealText>
                    <RevealText show={isInView} delay={2.8}>
                        Most don't know how to ask questions
                    </RevealText>
                    <RevealText show={isInView} delay={4.0}>
                        Most apps just show verses
                    </RevealText>
                    <RevealText show={isInView} delay={5.2} color="text-red-400">
                ...
                >
                    <button className="text-[#D4AF37] border-b border-[#D4AF37] pb-1 text-lg hover:text-white hover:border-white transition-colors">
                        See how it works ↓
                    </button>
                </motion.div>
