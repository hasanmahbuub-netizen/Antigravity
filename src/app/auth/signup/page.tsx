...
export default function SignUpPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[#050505] overflow-hidden relative px-4 pt-20 pb-10">
            {/* Background Glows */}
            ...
            >
                <div className="bg-card/40 backdrop-blur-xl p-8 rounded-[32px] border border-white/10 shadow-2xl">
                    <div className="text-center mb-10">
                        ...
                        <p className="text-muted-foreground">Join the MEEK community today</p>
                    </div>
